...
function check_update()
		...
		remote_version = luci.sys.exec("curl -skfL https://ghp.ci/https://github.com/ilxp/builder/releases/download/firmware/vermd5.txt")
...
function to_check()
    ...
    if board_name == "x86_64" then
    	...
    	if fs.access("/sys/firmware/efi") then
			download_url = "https://ghp.ci/https://github.com/ilxp/builder/releases/download/firmware/" ..remote_version.. "-oprx-x86-64-generic-squashfs-combined-efi.img.gz"
